...
- Получение информации о профиле GitHub
...
3. Вы можете изменять имя пользователя в форме и информация будет обновляться. Все данные сохраняются в файле resume.txt в папке data.
## Вклад
